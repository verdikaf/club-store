...
<head>
  ...
  <title>Warehouse - Kategori</title>
        ...
        <div class="container-fluid" style="padding-top: 15px;">
            ...
            <div class="col-md-12">
                <div class="card text-white bg-light mb-4 shadow-sm h-md-250">
                    ...
                    <strong class="d-inline-block mb-2 text-dark"><h3>KATEGORI</h3></strong>
                        <a class="btn btn-outline-dark btn-sm" role="button" href="{{url('/kategori/add')}}">Insert <i class="fa fa-plus "></i></a>
                    </div>
                    ...
                    <?php $no++ ;?>
                        <tr>
                            ...
                            <td >{{ $k->nama }}</td>
                            <td >
                                <a href="/kategori/edit/{{ $k->id }}" type="button" class="btn btn-warning btn-sm"><span class="fa fa-pencil" ></a>
                                <!-- <a href="/ecommerce/warehouse/kategori/delete/{{ $k->id }}" type="button" class="btn btn-danger btn-sm"><span class="fa fa-trash"></a> -->
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
